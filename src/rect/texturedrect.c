...
void texturedRectInit(TexturedRect* rect, Shader* shader) {
	loadTexture(&rect->sprite);
	
	rect->wasInitialized = 1;
    rect->shader = shader;
    genTexturedRectVertices(rect);
...
void genTexturedRectVertices(TexturedRect* rect) {
	...
	rect->vertices[3] = 0.0f;
	rect->vertices[4] = 1.0f;
	
    rect->vertices[5] = 1.0f;
    rect->vertices[6] = 0.0f;
    rect->vertices[7] = 0.0f;
	
	rect->vertices[8] = 1.0f;
	rect->vertices[9] = 1.0f;
	
    rect->vertices[10] = 0.0f; 
    rect->vertices[11] = 1.0f;
    rect->vertices[12] = 0.0f;
	
	rect->vertices[13] = 0.0f;
	rect->vertices[14] = 0.0f;
	
    rect->vertices[15] = 1.0f; 
    rect->vertices[16] = 1.0f;
    rect->vertices[17] = 0.0f;
	
	rect->vertices[18] = 1.0f;
	rect->vertices[19] = 0.0f;
